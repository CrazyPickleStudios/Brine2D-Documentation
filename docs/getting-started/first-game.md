...
You can find the complete source code for this tutorial in the [samples/BasicGame](https://github.com/CrazyPickleStudios/Brine2D/tree/main/samples/BasicGame) directory.
